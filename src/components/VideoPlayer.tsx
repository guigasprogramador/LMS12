    ...
    if (videoUrl.includes('youtube.com') || videoUrl.includes('youtu.be')) {
      try {
        ...
        if (videoId) {
          ...
          const embedUrl = `https://www.youtube-nocookie.com/embed/${videoId}?origin=${window.location.origin}&enablejsapi=1`;
          
          console.log('Renderizando vídeo do YouTube com URL:', embedUrl);
